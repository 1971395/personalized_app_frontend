...
import { Lightbulb, X, Loader2, Check, AlertCircle } from "lucide-react"

import { CATEGORIES, createIdea } from "@/lib/ideas"
    ...
    >
      ...
      <div className="flex flex-col gap-6">
        ...
        {status.state === "success" && (
          <div className="flex items-center gap-2 rounded-lg px-3.5 py-2.5 text-sm bg-zinc- bg-yellow-50 text-yellow-600">
